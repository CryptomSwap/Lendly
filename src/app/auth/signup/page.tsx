    ...
    <div className="min-h-screen bg-gradient-to-br from-cream via-cream to-warm-yellow/20 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          <LennyLogo size="md" />
          <span className="text-3xl font-bold bg-gradient-to-r from-coral to-teal bg-clip-text text-transparent">
            Lendly
          </span>
        </div>
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <p className="text-muted-foreground">
              Join the Tel Aviv gear sharing community
            </p>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <p className="text-sm text-blue-700">
                Fill out the form to create a demo account. All fields are optional for demo purposes.
              </p>
            </div>
            ...
            <div className="text-center text-sm text-muted-foreground">
              ...
              <Link href="/auth/signin" className="text-coral hover:underline">
                Sign in
              </Link>
            </div>
          </CardContent>
