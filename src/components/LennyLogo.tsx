...
export function LennyLogo({ className, size = 'md' }: LennyLogoProps) {
  const sizeClasses = {
    sm: 'w-6 h-6',
    md: 'w-8 h-8',
    lg: 'w-12 h-12'
  ...
  return (
    ...
    >
      ...
      <path d="M13 14C13 14 14.5 16 16 16C17.5 16 19 14 19 14" stroke="#1C1B22" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  )
}
